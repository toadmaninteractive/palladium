...
-module(web_rest_dashboard_data).
...
handle_get(Req) ->
    try
        ...
        Response = web_rest_callback_dashboard:get_dashboard_data(Project),
        Body = jsx:encode(web_protocol:dashboard_data_to_json(Response)),
