...
-module(web_rest_analytics_query).
...
handle_put(Req) ->
    try
        ...
        Response = web_rest_callback_analytics:send_analytics_request(Request, Project, Database, Query),
        Body = jsx:encode(web_protocol:analytics_query_result_to_json(Response)),
